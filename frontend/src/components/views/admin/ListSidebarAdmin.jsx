...
const ListSidebarAdmin = () => {
  ...
  const Navlist = [
    {
      id: 1,
      nama: t('admin.sidebar.dashboard'),
    ...
    {
      id: 2,
      nama: t('admin.sidebar.academicSystem'),
